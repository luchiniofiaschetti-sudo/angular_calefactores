...
- **Implementacion de CRUD para Calefactores**: Extender el panel de control para que no solo se administren los modelos, sino que tambien se pueda hacer un CRUD (agregar, modificar, eliminar).
